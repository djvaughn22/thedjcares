...
type EncouragementActionsProps = {
  ...
  // pill CTA to the source. "compact" is for the homepage: Share/Download/
  // Browse only — the "Play here" primary action and any inline player
  // live in HomeClient's own Daily Encouragement block, reusing the exact
  // same startItem → shared player pipeline the Podcasts tab already uses,
  // so there's one playback system, not two.
